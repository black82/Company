...
public class CompanyServiceImpl implements CompanyService {
    ...
    public List<CompanyDTO> getOllCompanyByCity(String city) {
        ...
        return companyRepository.findCompaniesByAddressCompany_Registrar (city)
                                .stream ()
    ...
    public List<Company> getFirst1000ByRegister_Officer(String register_officer) {
        return companyRepository.findCompaniesByAddressCompany_Registrar (register_officer);
    }
    ...
    public List<CompanyDTO> searchBYActyvityAndAddress(String activity,
            String address) {
        return companyRepository.findCompaniesByRegistered_addressAndActivity (address, activity)
                                .stream ()
                                .map (company -> modelMapper.map (company, CompanyDTO.class))
                                .collect (Collectors.toList ());
    }
